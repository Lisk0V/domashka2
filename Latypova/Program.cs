...
namespace Latypova
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Drink[] drinks =
            {
                new Drink {Name="Пиво",Percent=6},
                new Drink {Name="Сидр",Percent=15},
                new Drink {Name="Самогон",Percent=45},
                new Drink {Name="Вода",Percent=0}    
            };
            Student[] students =
            {
                new Student {LastName= "Шмаков",FirstName="Родион", ID=1,Category=Alcohol.b,DrinkType=drinks[2],V=200},
                new Student {LastName= "Шишкин",FirstName="Сергей", ID=2,Category=Alcohol.a,DrinkType=drinks[1],V=360},
                new Student {LastName= "Гордей",FirstName="Иван", ID=3,Category=Alcohol.c,DrinkType=drinks[0],V=60},
                new Student {LastName= "Ларина",FirstName="Анна", ID=4,Category=Alcohol.d,DrinkType=drinks[3],V=1550},
                new Student {LastName= "Орловский",FirstName="Никита", ID=5,Category=Alcohol.b,DrinkType=drinks[2],V=200}
            };
            double obshV = 0;
            double obshAl = 0;
